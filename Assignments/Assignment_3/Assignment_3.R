...
class(vector1)
vector1 <- 1:10 # another way, since these are integers
...
class(vector3) # find out what type of vector you're dealing with
class(vector1)
class(vector2)
...
plot(x=factor(dat$Petal.Length), y=dat$Sepal.Length)
